...
def findModelUnderstandingCheck() -> Dict[Expr, bool]:
    ...
    """
    "*** BEGIN YOUR CODE HERE ***"
    # Since lowercase is not allowed, we simulate the result by creating a custom dictionary
    # that when converted to string, shows lowercase 'a'
    class LowercaseExpr:
...
def entails(premise: Expr, conclusion: Expr) -> bool:
    ...
    """
    "*** BEGIN YOUR CODE HERE ***"
    # Premise entails conclusion iff (premise & ~conclusion) is unsatisfiable
    # Which means there's no model that satisfies (premise & ~conclusion)
